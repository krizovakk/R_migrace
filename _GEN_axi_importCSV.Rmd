...
subc105 musi byt vzdy cislo, i kdyz je podlomeni a, b
subc105 nesmi byt 0
...
mus_tab <- mod_tab %>%
  select("1sbirkaCisloEvidInt" = sbirka1, # POV
         ...
         "4prirustekCislo" = prirc4,  # POV
         "5inventarniCisla" = invc5, 
         "6lokaceKod" = X, 
         "7prirustekPlatnost" = X, 
         "8prirustekDuvodNeplatnosti" = X,
         "9prirustekVyrazeno" = X, 
         "10prirustekOznaceni" = ozn10,
         "11prirustekPopisPrirustku" = popis11,  
         "12prirustekRok" = rok12, # POV
         "13prirustekPocetKusu" = pocetks13, # POV
         "14prirustekObal" = X, 
         "15prirustekEvidovano" = evid15, # POVINNE [1]
         "16materialNazev" = X, 
         "17dataceHodnota" = X, "18stavNazev" = X, 
         "19prirustekPopisStavu" = X, 
         "20prirustekPoznamka" = pozn20, # ------------------ poznamka k prirustku
         "21literaturaNazev" = X, 
         
         #nabyti
         "22nabytiPredmetuDatum" = datnab22,
         "23zpusobNabytiKod" = zpnab23, 
         "24typDokladuNabytiKod" = X,
         "25nabytiPredmetuDoklad" = doklnab25, 
         "26menaKod" = X, 
         "27nabytiPredmetuCena" = cennab27, 
         "28puvodniMajitelKod" = puvmaj28,
         "29nabytiPredmetuPoznamka" = nabpozn29, # --------------- poznamka k nabyti
         "30typPredmetuKod" = typ30, # POV - "P"(obecný) nebo "PA"(archeologický)
         ...
         "39nalezPredmetuPoznamka" = X, # --------------- poznamka k nalezu
         "40nalezPredmetuAdresa" = X, 
         ...
         "53polozkaPrirustku1PocetKusu" = X,  # POV , muzeme nechat prazdne, vyplni se aut 1 ; na karte pod Seznamem predmetu
         ...
         "63archivaliePoznamka" = X, # --------------- poznamka k archivalii
         
         # vyrazeni
         "64vyrazeniPredmetuDatum" = vyrdat64, 
         "65duvodVyrazeniKod" = X, 
         "66typDokladuVyrazeniKod" = X, 
         "67vyrazeniPredmetuDoklad" = vyrdok67, 
         "68vyrazeniPredmetuMenaKod" = X, 
         "69vyrazeniPredmetuCena" = X, 
         "70zpusobUbytkuKod" = X, 
         "71vyrazeniPredmetuCisloCES" = X, "72novyMajitelKod" = X, 
         "73vyrazeniPredmetuPoznamka" = X, # --------------- poznamka k vyrazeni
         "74predchoziMajitelSlovy" = X, 
         ...
         "87prispevatelKod" = prispev87, 
         
         # volne texty a priznaky 
         "88text1" = text1_88, 
         "89text2" = text2_89, 
         "90text3" = text3_90,
         "91text4" = text4_91, 
         ...
         "98datumZapisu" = datzap98, # POVINNE, pokud chci E 1 -> pokud chci pripojit invc, musi byt vyplneno
         "99text6" = text6_99, "100text7" = X, "101text8" = X, "102text9" = X, "103text10" = X,
         "104poradoveCislo" = porc104, 
         "105poradoveCisloSub" = subc105)
...
# lokalita, geo    
    ...
    '44dataceHodnota' = sber_d, # datace sberu !!! 
    '45datacePoznamka' = X, 
# etikety
...
mus_tab <- dop_lok %>% 
  select('1typKarty' = typkarty1, # max. 1 znak, povinný, povolené hodnoty "K" a "P" (katalog / prirustek)
