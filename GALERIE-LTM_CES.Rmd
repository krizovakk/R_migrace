...
mysheets <- read_excel_allsheets("C:/Users/katerina.krizova/Documents/R/CES/GALERIE-LTM/GALERIE-LTM_PK.xlsx")
...
# 9.9.2024
# kontrola, zda existuje prirustkove cislo;
# prikaz bude vypadat takto:
...
r_upd <- spa %>% filter(duvod == "R") %>% 
  mutate(prikaz = paste0("update PRIRUSTEK set HLASENODOCES = 1, ZKATALOGIZOVANO = 1, CISLOCES = '", CES_cislo, "', uupd = \'krizova_impl\', dupd = '09.09.2024' WHERE PRIRUSTEK.ID = ", id, " AND exists(select ID from sbirkovypredmetprirustek WHERE prirustek_id = ", id, ");")) %>% 
  select(prikaz)

write.table(r_upd, file = "C:/Users/katerina.krizova/Documents/R/CES/GALERIE-LTM/GALERIE-LTM_updt_PK_rozepsane.sql", quote = F, row.names = F, col.names = F)
...
mysheets <- read_excel_allsheets("C:/Users/katerina.krizova/Documents/R/CES/GALERIE-LTM/GALERIE-LTM_KAT.xlsx")
...
# 9.9.2024 update PRIRUSTEK set HLASENODOCES = 1, ZKATALOGIZOVANO = 1, CISLOCES = '11/2003', uupd = 'krizova_impl', dupd = '09.09.2024' 
s_upd <- spa %>%
  mutate(prikaz = paste0("update PREDMET set SP_HLASENODOCES = 1, SP_CISLOCES = '", CES_cislo, "', uupd = 'krizova_impl', dupd = '09.09.2024' WHERE PREDMET.ID = ", sp_id, ";")) %>% 
  select(prikaz)          

write.table(s_upd, file = "C:/Users/katerina.krizova/Documents/R/CES/GALERIE-LTM/GALERIE-LTM_updt_KAT.sql", 
            quote = F, row.names = F, col.names = F)
