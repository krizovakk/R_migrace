...
write.table(mus_tab, paste0(path_csv, "csv_techpred.csv"), 
            sep = ";", quote = F, row.names = F, 
            na = "", fileEncoding="cp1250")
...
mus_tab <- modify_tab %>% 
  select(
    ...
    '23jinaEvidence2Cislo' = MEMPTY,'24jinaEvidence3Cislo' = MEMPTY,
    ...
    '30SPUUpd' = MEMPTY, '31SPDUpd' = MEMPTY, # UPRAVA ZAZNAMU 
    
    '32stalaLokaceKod' = MEMPTY, '33aktualniLokaceKod' = MEMPTY, # LOKACE (migruje se zvlast)
    
    '34predmetNazev' = Titul_S, '35oznaceni1Nazev' = Predmet_S, # PREDMET
    '36odborneUrceniPopis' = Popis_S, '37odborneUrceniPopis2' = MEMPTY, 
    '38odborneUrceniPoznamka' = Pozn_S, '39kompletnostKod' = MEMPTY,
    ...
    '71zpusobNabytiKod' = ZpAkv_AQ,'72nabytiPredmetuDatum' = DatAkv_AQ, # NABYTI
    '73nabytiPredmetuRokAkvizice' = MEMPTY,'74nabytiPredmetuDoklad' = CDoklAkv_AQ,
    '75nabytiCena' = MEMPTY,'76nabytiMena' = MEMPTY,
    '77predchoziMajitelSlovy' = PredMajSlovy_AQ,'78puvodniMajitelKod' = MEMPTY,
    '79prispevatelKod' = MEMPTY,'80nabytiPoznamka' = Okolnosti_AQ,
...
mus_tab$'27archivalie' <- as.integer(as.logical(mus_tab$'27archivalie'))
...
write.table(mus_tab_cvic, paste0(path_csv, project, "_csv_obp.csv"), 
            sep = ";", quote = F, row.names = F, 
            na = "", fileEncoding="cp1250")
