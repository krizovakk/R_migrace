...
subtitle: "Základní dokument pro úpravy dle specifik zadání projektu"
...
mus_tab <- modify_tab %>% 
  select(
    ...
    '21SPPocetKusu' = Pocet_S,
    '22jinaEvidence1Cislo' = MEMPTY, '23jinaEvidence2Cislo' = MEMPTY,'24jinaEvidence3Cislo' = JineC_S,
    ...
    '81lokalitaNalezuNazev' = Lokalita_S,'82lokalitaDoplneni' = MEMPTY, # LOKALITA
    ...
    '115rokPrirust' = MEMPTY,'116mnozstviSlovy' = MEMPTY,        # PRIRUSTEK
