...
mus_tab <- modify_tab %>% 
  select(
    ...
    '4materialNazev'= Material_MA,  # !! povinne !!
...
mus_tab <- modify_tab %>% 
  select(
    '1sbirkaCisloEvidInt' = '1sbirkaCisloEvidInt', '2podsbirkaCislo'= '2podsbirkaCislo', 
    '3materialovaSkupinaKod' = MEMPTY, 
    '4technikaNazev'= Technika_TE,  # !! povinne !!
...
write.table(mus_tab, paste0(path_csv, "csv_fot.csv"), 
            sep = ";", quote = F, row.names = F, 
            na = "", fileEncoding="cp1250")
...
write.table(mus_tab, paste0(path_csv, "csv_bio.csv"), 
            sep = ";", quote = F, row.names = F, 
            na = "", fileEncoding="cp1250")
...
write.table(mus_tab, paste0(path_csv, "csv_br.csv"), 
            sep = ";", quote = F, row.names = F, 
            na = "", fileEncoding="cp1250")
```
