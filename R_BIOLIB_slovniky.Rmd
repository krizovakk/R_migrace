...
path_mdb <-  "M:/03 klienti/kraj moravskoslezsky/muzeum beskyd - MUZBE/"

```


# NACTENI BIOLIB SLOVNIKU (KK sum)

```{r BIOLIB DICT}

biolib <- read.table(paste0(path, "BioLib_KKsummary.csv"), sep = ";", header = T)
...
dbname <- paste0(path_mdb, "01 muzBE analyza/PVO/Databaze_PVO_2021-11-03.accdb") # path to database
...
zoo <- RODBC::sqlFetch(con, "Pz_System_ZOOpredmety")
