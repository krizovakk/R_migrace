...
# ces_ic <- ic %>% 
#   mutate(Mrada = str_replace_all(cislo, "[:digit:]+", ""),
#          Mrada = str_trim(Mrada),
#          Mcislo = str_extract(cislo, "[:digit:]+"),
...
#                               TRUE ~ Mcislo), 
#          Mrada0 = case_when(Mrada == "CV - N" ~ "CV-N",
#                            Mrada == "L" ~ "chybi",
#                            Mrada == "La x" ~ "La",
#                            Mrada == "LE" ~ "Le",
#                            Mrada %in% c("M T č /", "MT č", "MT č /", "MT č /-", "MT č //",
#                                         "MT č //-", "MT č //,", "MT č //,-", "MT č //a",
#                                         "MT č /a", "MTč/") ~ "MTč",
#                            TRUE ~ Mrada)) %>% 
#   unite(MINVC, c(Mrada, Mcislo_0), sep = "", na.rm = T, remove = F)  

ces_ic <- ic %>%
  mutate(Mrada = case_when(
