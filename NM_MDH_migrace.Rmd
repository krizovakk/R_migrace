...
```{r CHECK ROLES AND LOCS DICTIONARY}
...
dopr_tab <- sbirky %>% 
  ...
  mutate(MDAT_YM = substring(ifelse(str_detect(MDATACE, "^([0-9]{4})[_]([0-9]{1})([1-9]{1})[_]00$"),
                                    MDATACE, ""), 1, 7)) %>% 
...
save <- paste0(path_csv, spravce, "_import_obp_CVICNE.csv")
